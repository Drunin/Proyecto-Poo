...
public class Profesor extends Usuario {
    ...
    String fechaingreso;
//Se inicializan todoss los atributos de la clase profesor 
...
//agrega un profesor creadoa un txt
...
//        }
    ...
    public static int LineasArchivo() {
        File input = new File("profesores.txt");
        int numLines = 0;
        try {
...
//crea una lista de profesores a partir de un txt
